...
R_light = nav.npload("/src", "data", f"responses_{data_type}_hollow={int(hollow)}_lw={linewidth}_light=1", f"CR_stim=shape_key={hidden_key}.npy")
R_dark = nav.npload("/src", "data", f"responses_{data_type}_hollow={int(hollow)}_lw={linewidth}_light=0", f"CR_stim=shape_key={hidden_key}.npy")
